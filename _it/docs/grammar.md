...
## Come sono organizzate le note grammaticali

- **Per livello** — le note sono graduate da A1 (principiante) a C1 (avanzato), così puoi abbinarle al punto in cui sei.
- **Per categoria** — all'interno di un livello, le note sono raggruppate per argomento, come «Verbi, tempi e coniugazione», «Pronomi» o «Preposizioni e congiunzioni».

Ogni nota porta dei badge che ne mostrano livello e categoria.

## Cosa contiene una nota

- Una spiegazione del concetto, scritta per chi impara, con parole e frasi di esempio.
...
Per i dettagli, vedi [Leggere le note grammaticali](grammar/review-grammar.md).

---
title: Llegir notes gramaticals
parent: Gramàtica
lang: ca
---

# Llegir notes gramaticals

Com trobar la nota que necessites, canviar-la de llengua, treballar-ne els exercicis i tenir-la marcada per a la propera vegada.
...
Una nota gramatical explica un sol concepte — el seu títol apareix en la llengua d'aprenentatge, amb el títol traduït a sota quan existeix una traducció. Les insígnies mostren el **nivell CEFR** de la nota (A1–C1) i la seva **categoria**.
...
Per respondre un exercici:

1. Omple el buit — escrivint la teva resposta o triant d'una llista, segons l'exercici.
2. Prem **Comprovar**. Reps una resposta immediata sobre si la teva resposta era correcta.

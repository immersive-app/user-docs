---
title: Ler observações gramaticais
parent: Gramática
lang: pt
---
...
Uma observação gramatical explica um conceito — o título aparece na língua que está a aprender, com o título traduzido por baixo quando existe tradução. Os distintivos mostram o **nível CEFR** da observação (A1–C1) e a sua **categoria**.
...
Para responder a um exercício:

1. Preencha o espaço em branco — escrevendo a resposta ou escolhendo de uma lista, conforme o exercício.
2. Prima **Checar**. Recebe imediatamente feedback sobre se a resposta estava certa.
